/****** Object:  Procedure [dbo].[sp_3040_ProcessarNP]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[sp_3040_ProcessarNP]
    @id_fundo       INT, 
    @data           DATE,
    @user           VARCHAR(50), 
    @cdError        INT OUTPUT, 
...
BEGIN
   ...
   SELECT @FUNDO =  ID_FUNDO FROM #OP 

   IF @ID_FUNDO NOT IN ( SELECT ID_FUNDO FROM TB_3040_BAS_FUNDO WHERE NM_FUNDO LIKE '%IPANEMA%')
   ...
   INSERT INTO TB_3040_XML_INF
    SELECT      CONVERT(VARCHAR, DT_AQUISICAO, 120) AS CODIGO,
                ...
                CASE    WHEN o.CD_ANEXO_02 = '04' AND 1=1 THEN o.VL_PERC_COOBRIGACAO
						...
						WHEN o.CD_ANEXO_02 = '16' THEN 0.00
